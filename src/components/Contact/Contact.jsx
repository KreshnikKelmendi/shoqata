                ...
                <div className="">
                    <div className=" flex flex-col lg:flex-row justify-center items-center">
                            ...
                            <div className="mb-12 lg:mb-0">
                                ...
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-base font-custom">
                                            Eye Clinic, Rrethi i Spitalit pn, Prishtinë
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="mb-8 flex w-full">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-base text-body-color dark:text-dark-6 font-custom">
                                            <a href="tel:+38344511655">+383 44 511 655</a>
                                        </p>
                                        <p className="text-base text-body-color dark:text-dark-6 font-custom">
                                            <a href="tel:+38344495072">+383 44 495 072</a>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-base text-body-color dark:text-dark-6 font-custom hover:text-blue-700">
                                            <a href="mailto:info.shofk@gmail.com" className="hover:underline">info.shofk@gmail.com</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="lg:w-1/2 w-full">
                          <iframe 
                            title="Location of SHOFK" 
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2934.649453297572!2d21.159543075016593!3d42.64759091688937!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x13549eeb2728eb15%3A0xdd65e66ce05061ee!2sRrethi%20I%20Spitalit!5e0!3m2!1sen!2s!4v1720524969485!5m2!1sen!2s"
